...
import { ChevronLeft, Save, Shield, UserCircle, Lock, LogOut } from "lucide-react";
  ...
  const changePassword = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        ...
        { currentPassword: passwords.current, newPassword: passwords.new }, // ✅ fixed newPassword
        { headers: { Authorization: `Bearer ${token}` } }
      );
      if (data.success) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <section className={SECTION_WRAPPER}>
            <div className="flex items-center gap-2 mb-6">
              <UserCircle className="text-purple-500 w-5" />
          ...
          <section className={SECTION_WRAPPER}>
            <div className="flex items-center gap-2 mb-6">
              <Shield className="text-purple-500 w-5" />
