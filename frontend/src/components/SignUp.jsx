...
import {FIELDS, BUTTONCLASSES, Inputwrapper, MESSAGE_ERROR, MESSAGE_SUCCESS} from "../assets/dummy"
    ...
    return (
        <div className="max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8">
            <div className="mb-6 text-center">
                ...
                <p className="text-gray-500 text-sm mt-1"> Join TaskFlow to manage your tasks
                </p>
            </div>
            {message.text && (
